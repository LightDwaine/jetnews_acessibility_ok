...
val post4 = Post(
    ...
    subtitle = "Technology Expose resource IDs from ViewModels to avoid showing obsolete data.",
...
val post5 = Post(
    ...
    subtitle = "Work with collections is a common task and the Kotlin Standard Library offers many great utility functions. It also offers two ways of…",
